...
class Home extends AUTH_Controller {
	...
	public function index() {
		$data['jml_guru'] 		= $this->M_guru->total_rows();
		$data['jml_izin'] 		= $this->M_izin->total_rows();
		...
		foreach ($posisi as $value) {
			...
			$pegawai_by_posisi = $this->M_guru->select_by_posisi($value->id);
		...
		foreach ($kota as $value) {
			...
			$pegawai_by_kota = $this->M_guru->select_by_kota($value->id);
