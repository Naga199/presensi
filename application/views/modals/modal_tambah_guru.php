<div class="col-md-offset-1 col-md-10 col-md-offset-1 well">
  ...
  <form id="form-tambah-guru" method="POST">
    ...
    <div class="input-group form-group">
      ...
      <input type="text" class="form-control" placeholder="NUPTK" name="nuptk" aria-describedby="sizing-addon2">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
    ...
    <div class="input-group form-group">
      ...
      <input type="date" class="form-control" placeholder="TTL" name="ttl" aria-describedby="sizing-addon2">
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
    ...
    <div class="input-group form-group">
      ...
      <select name="status" class="form-control select2" aria-describedby="sizing-addon2" style="width: 100%">
          ...
          <option value="honorer">Guru Honorer Sekolah</option>
          <option value="tenaga">Tenaga Honorer Sekolah</option>
      </select>
    </div>
    <div class="input-group form-group">
      <span class="input-group-addon" id="sizing-addon2">
    ...
    <div class="input-group form-group">
      ...
      <textarea type="text" class="form-control" placeholder="Alamat" name="alamat" aria-describedby="sizing-addon2"></textarea>
    </div>
